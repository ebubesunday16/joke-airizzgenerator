  ...
  return (
              ...
              {menuItems.length>0 &&(menuItems.map((menu) => (
                ...
                >
                  <div className='flex gap-2 justify-between items-center'>
                    <a href={`https://airizzgenerator.com${menu.href}`} className=" text-xs ">
                      {menu.label}
                    </a>
                    ...
                    <div className="absolute top-full -right-4 w-48 mt-5 bg-white rounded-md shadow-Btn border-2 border-black">
                      <ul className="py-1">
                        {menu.content.map((menuitem) => (
                          ...
                          >
                            <a
                              href={`https://airizzgenerator.com${menuitem.href}`}
    ...
    <ul className="py-1">
      {menuItems.map((menu) => (
        ...
        >
          <a
            href={`https://airizzgenerator.com${menu.href}`}
              ...
              <div className=" mt-2  ">
                {menu.content.map((item, index) => (
                  <div className='flex items-center justify-start gap-[1px]'>
                    ...
                    <a
                      key={index}
                      href={`https://airizzgenerator.com${item.href}`}
